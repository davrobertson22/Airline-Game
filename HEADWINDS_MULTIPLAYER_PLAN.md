...
world          id, name, status(lobby|running|ended), visibility(public|private),
               pace(week_ms), current_week, current_year, season_end_year,
               max_players, join_code, tick_config(jsonb),
               world_seed, created_at, started_at, ended_at
