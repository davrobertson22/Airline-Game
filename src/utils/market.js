...
// suppress a sub-65 km different-city pair UNLESS it is an explicit water-hop
// exception below.
...
// within a page load, and caching it cannot freeze a growing market.
//
// It is also the single hottest function in the weekly tick. Profiled at 279
// routes (2026-09-08, the Discord report of a laggy 1991 save): 38% of tick
// self-time, because buildOwnMetalConnections asks it about every pair of spokes
// at every hub — ~38,000 calls a week for a single 279-spoke hub, re-deriving
// the same gravity model from the same constants every time.
//
