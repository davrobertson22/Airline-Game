...
export const AIRCRAFT_TYPES = [
  ...
  },
  {
    ...
    description: 'The Queen of the Skies. Its 660-seat exit limit is the highest of any 747 and it is cheap to acquire, but four thirsty engines make it a high-density trunk aircraft rather than an efficient one.',
  ...
  },
  {
    ...
    description: 'Latest and longest 747 — but Boeing never re-certified the exit limit, so it is placarded for 55 fewer seats than the -400 despite the stretch. What it buys instead: a fifth less fuel per seat and 1,400 km more range.',
  ...
  },
  {
    ...
    crewCostPerKm: 4.14,
    baseMaintenancePerWk: 275_000,
    description: 'The stretched-upper-deck 747. Shares the -400 cabin and its 660-seat exit limit for a fraction of the price — older engines make it far thirstier and it gives up 1,700 km of range.',
