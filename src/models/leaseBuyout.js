 ...
 *
 * Ported from Headwinds along with the feature, and deliberately NOT ported as
 * written. Headwinds priced the buyout with a standalone helper in
 * data/aircraft.js that computed its own net asset value:
 *
 ...
 * $36.8M on an An-225, and 108 of 164 leasable types turned a profit.
 * Tailwinds never shipped a buyout, so it never shipped that bug; what lands
 * here is the fixed version, and tools/lease-buyout-test.mjs keeps it fixed.
 *
 ...
 * toast) need the same answer, and three hand-rolled copies of "what is this
 * jet worth" is exactly how Headwinds got into that state. Both the
 * price the dialog quotes and the price the reducer charges come from this
