...
function loyaltyTierLabel(investment) {
  if (investment <= 0)        return { label: 'None',   color: '#6e7681' };
  if (investment < 100_000)   return { label: 'Basic',  color: '#3fb950' };
  if (investment < 250_000)   return { label: 'Silver', color: '#8b949e' };
  if (investment < 500_000)   return { label: 'Gold',   color: '#d29922' };
    ...
    <div className="page-content">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, marginBottom: 20 }}>
        ...
        <StatCard
          ...
          color={totalWeeklyCost > 0 ? '#f85149' : '#6e7681'}
        />
      </div>
          ...
          {[
            ...
            <div key={m} style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 6 }}>
              <span style={{
                ...
                background: members >= m ? '#3fb950' : 'var(--border)',
              }} />
