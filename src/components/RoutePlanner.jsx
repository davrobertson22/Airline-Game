...
import {
  ...
  formatMoney, formatPercent, currentGameDate,
...
export default function RoutePlanner() {
  ...
  //
  // It lives BELOW configSource on purpose: suites that seed this component's
  ...
  // economics, and on a thin lane the two part company hard: measured before this
  // landed, against a three-type fleet, the default pick was not the best earner
  // on 380 of 400 lanes, by an average of $406K/wk — a 189-seat jet at 30% load
  // losing to a 55-seat one that fills.
  //
  ...
  }, [ready, origin, dest, frequency, season, state.gates, state.routes, state.cargoRoutes]);
