...
const CLASS_COLORS = {
  firstClass:     '#bc8cff',
  businessClass:  '#d29922',
  premiumEconomy: '#388bfd',
  economy:        '#3fb950',
};
        ...
        <div style={{ padding: '14px 20px' }}>
          ...
          <section style={{ borderTop: '1px solid var(--border)', paddingTop: 14, marginBottom: 14 }}>
            ...
            {(first + biz + prem > 0 || seatQ !== 'standard' || servQ !== 'standard') && (
              <div style={{ marginTop: 8, padding: '7px 10px', background: 'rgba(163,113,247,0.1)', borderRadius: 5, fontSize: 12, color: '#a371f7', border: '1px solid rgba(163,113,247,0.25)', display: 'flex', alignItems: 'center', gap: 6 }}>
                <span>💺</span>
                <span>
                  {[
                    first > 0 && `${first}F`,
