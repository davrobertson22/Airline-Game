...
export default function Dashboard() {
  ...
  // Distinct city pairs (direction-agnostic), matching the Routes page's
  // grouping — so the Fleet card reads real route count instead of counting
  // each aircraft deployment separately (multiple planes on one pair used to
  // inflate it). Passenger and freight pairs are counted separately, as the
  // Routes page splits them into their own views.
