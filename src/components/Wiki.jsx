...
const WIKI = [
  ...
  },
  {
    ...
    blocks: [
      { p: 'A loyalty program turns one-time flyers into repeat customers. Set a **weekly investment** — preset tiers run from None through Basic, Silver, Gold and Elite — to enrol members over time.' },
      { h: 'What members do for you' },
      { ul: [
        'They\'re **less price-sensitive** — they book with you even when rivals undercut, reducing churn on competitive routes (up to ~15% sensitivity reduction at scale).',
        'They add a **reputation bonus** (+1 per ~12,500 members, up to +8).',
        'They provide a small **demand boost** across all routes.',
      ] },
      { h: 'The cost' },
      { p: 'You pay your weekly investment plus a **points cost** that scales with your member base (members redeem points for free or discounted seats). Bigger programs cost more to run, so grow membership in step with revenue.' },
      { tip: 'Higher investment enrols members faster and unlocks better benefits. Start modestly and scale up as your passenger volume grows.' },
    ],
  },
  {
    id: 'alliances',
