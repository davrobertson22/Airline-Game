...
//
// Reported in Headwinds (Discord, 2026-08-26) and ported here, where the same
// form carried the same defect: the Add Flights form showed a
...
const { addRouteBlockReason } = await import('../src/store/GameContext.jsx');
