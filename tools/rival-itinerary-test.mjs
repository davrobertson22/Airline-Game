...
import { buildRouteMarket, computeMarketShare, HUB_TIERS } from '../src/models/demand.js';
import { rivalOffersFor, simulateRoute, defaultConfig } from '../src/utils/simulation.js';
