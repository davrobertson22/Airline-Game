...
const { prepareWeek } = await import('../src/utils/tickPrep.js');
const { weeklyTick, defaultConfig, defaultClassPrices } = await import('../src/utils/simulation.js');
const { referencePrice } = await import('../src/utils/market.js');
