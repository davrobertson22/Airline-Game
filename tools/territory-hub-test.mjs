...
//
//   node --import ./tools/_register-loader.mjs tools/territory-hub-test.mjs

import assert from 'node:assert/strict';
import { sovereignCountry, sameSovereign, SOVEREIGN_OF } from '../src/data/territories.js';
import { hubUpgradeChecklist, intlDestinationsFrom } from '../src/models/demand.js';
