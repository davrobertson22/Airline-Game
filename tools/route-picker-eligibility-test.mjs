...
import { MAX_WEEKLY_BLOCK_HOURS, deployableFleetForRoute, deploymentShortfall, routeDistanceKm, effectiveRangeKm } from '../src/utils/simulation.js';
...
test('a plane with no block hours left is not offered', () => {
  ...
  // the subject here is the PICKER, not the migration.
  const saturated = {
    ...save,
