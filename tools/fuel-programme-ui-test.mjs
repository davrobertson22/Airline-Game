...
import { referencePrice, defaultConfig, defaultClassPrices, simulateRoute } from '../src/utils/simulation.js';
import { projectWeek } from '../src/utils/financeProjection.js';
import { FUEL_PROGRAMMES, programmeActivationCost } from '../src/data/fuelProgrammes.js';
import { wingtipRetrofitCost } from '../src/data/retrofits.js';
