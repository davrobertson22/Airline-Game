...
import { AIRCRAFT_TYPES, getAircraftType, eraDeliveredAgeWeeks, isVintage } from '../src/data/aircraft.js';
import { getAirport, AIRPORTS } from '../src/data/airports.js';
import {
  calcHQCost, hqScaleFor, weeklyInsuranceCost, weeklyLandingFee,
} from '../src/data/overhead.js';
import { LABOR_GROUPS, crewScaleFor } from '../src/data/labor.js';
...
import { referencePrice, expectedCarried } from '../src/utils/market.js';
