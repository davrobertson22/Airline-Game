...
} from '../src/data/fuelProgrammes.js';
import {
  canRetrofitWingtips, wingtipRetrofitCost, fitWingtips, WINGTIP_RETROFIT_PREMIUM,
} from '../src/data/retrofits.js';
import { fuelSimMultiplierOf, fuelPriceMultiplierOf, resolveFuelForWeek } from '../src/utils/fuelOps.js';
import { prepareWeek } from '../src/utils/tickPrep.js';
import { projectWeek } from '../src/utils/financeProjection.js';
import { rollMechanicalFailures } from '../src/data/events.js';
import { isOutOfService } from '../src/data/maintenance.js';
...
import { runScenario, makeRng } from './fuel-scenario.mjs';
