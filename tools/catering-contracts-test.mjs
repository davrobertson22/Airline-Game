...
import { HUB_TIERS } from '../src/models/demand.js';
import { defaultAncillaries } from '../src/data/ancillaries.js';
import { routeCatering, CATERING_LEVEL_ORDER, CATERING_LEVELS } from '../src/data/catering.js';
...
import { routeStops } from '../src/utils/simulation.js';
...
const { gameReducer, freshState, reconcileState } = await import('../src/store/GameContext.jsx');
