...
//   node --import ./tools/_register-loader.mjs tools/mro-base-test.mjs
//
...
import * as M from '../src/data/maintenance.js';
import * as B from '../src/data/mroBase.js';
import { weeklyFamilyBaseCost, aircraftFamily, FAMILY_INFO } from '../src/data/families.js';
