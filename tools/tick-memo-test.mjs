...
const { AIRPORTS, getAirport } = await import('../src/data/airports.js');
const { baseCityPairDemand, clearPairDemandMemo } = await import('../src/utils/market.js');
const { scaleBySeats, CATEGORY_MEDIAN_SEATS } = await import('../src/data/overhead.js');
