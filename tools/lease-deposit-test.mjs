...
// up front (GameContext ORDER_AIRCRAFT), and NOTHING ever gave it back.
//
...
//   * The delivered aircraft did not carry `leaseDeposit` at all, so by the
//     time the tail existed the money had no record attached to it.
...
test('the deposit is twelve weeks of the rate this order signed at', () => {
  assert.equal(theOrder.leaseDeposit, theOrder.weeklyLease * 12);
});
