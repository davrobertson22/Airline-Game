...
import { weeklyTick, aircraftHubMaintFactor, defaultConfig, defaultClassPrices } from '../src/utils/simulation.js';
...
import { DEFAULT_LABOR_STATE } from '../src/data/labor.js';
