...
// Tailwinds keeps the map geometry inside RouteMap.jsx (no shared mapCore).
const { chainKey, segmentsForChain, TAG_COLOR } = RouteMapMod;

// segmentsForRoute is module-private there; the single-leg arc for the control
// assertion is the two-point chain, which is the same great circle.
const segmentsForRoute = (lat1, lon1, lat2, lon2, n) => segmentsForChain([[lat1, lon1], [lat2, lon2]], n);
