...
//
// but six reducer paths rewrote `status` from the route table alone —
// CLOSE_ROUTE, CLOSE_CARGO_ROUTE, ADD_ROUTE, ADD_TAG_ROUTE, ADD_CARGO_ROUTE
// and the TRANSFER_ROUTES donor. Closing a broken tail's last
...
//
//   node --import ./tools/_register-loader.mjs tools/grounding-persistence-test.mjs
